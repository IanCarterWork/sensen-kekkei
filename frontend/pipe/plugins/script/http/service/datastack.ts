...
export type DataStackServiceMethods = 'GET' | 'POST' | 'PUT' | 'OPTIONS' | 'PATCH' | 'DISPATCH' | 'HEAD' | 'DELETE' | 'CONNECT' | 'TRACE' | 'TOGGLE'


export type DataStackServiceOutput = '-arraybuffer' | '-blob' | '-text' | '-formdata' | '-json'


export type DataStackServiceSettings = {
    Provider?: string;
...
export type DataStackServiceOptions = RequestInit & { }


export type DataStackServiceEvents<T extends DataStackServiceResponseData> = {
...
export type DataStackServiceResponseData = {
    [K: string] : any
}


export type DataStackServiceProps<T> =  DataStackServiceEvents<T> & {
    Name: string;
...
export type DataStackServiceFeatures<T> = DataStackServiceProps<T> & {
    Response?: Response;
